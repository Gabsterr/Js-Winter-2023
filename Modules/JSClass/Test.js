...
let newArr2 = arr1.slice(3, 6);

let arr1Result = [newArr1 + "," + newArr2];  // final ans should be in this variable (get values in arr1Result from arr1 which are NOT equals to num1)
